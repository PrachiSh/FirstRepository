...
(define rec-10-and-5 ( make-rec REC-IMAGE 2 2 10 5 true))
(define rec-10-and-6 ( make-rec REC-IMAGE 2 2 10 6 false))
...
(begin-for-test
  (check-equal?
   (in-y-vel rec-10-and-5)  (make-rec REC-IMAGE 2 2 10 7 true)))
...
(begin-for-test
  (check-equal?
   (de-y-vel rec-10-and-5)  (make-rec REC-IMAGE 2 2 10 3 true)))
...
(begin-for-test
  (check-equal?
   (de-x-vel rec-10-and-5)  (make-rec REC-IMAGE 2 2 8 5 true)))
...
(begin-for-test
  (check-equal?
   (in-x-vel rec-10-and-5)  (make-rec REC-IMAGE 2 2 12 5 true)))
...
(define (draw-list l)
  (cond [(empty? l) empty-canvas]
        [else  ( place-image (overlay-velocity l) (rec-x-pos (first l)) (rec-y-pos (first l)) (draw-list (rest l)))]))
...
(begin-for-test
  (check-equal?
   (selected-rec rec-10-and-5)  (make-rec REC-IMAGE 2 2 10 5 true)))
...
(begin-for-test
  (check-equal?
   (checking-width rec-10-and-6)  (make-rec REC-IMAGE -8 2 -10 6 false)))
...
(begin-for-test
  (check-equal?
   (checking-height rec-10-and-6)  (make-rec REC-IMAGE 2 -4 10 -6 false)))
...
(define (tick-rec r)
   (make-rec REC-IMAGE
   (+ (rec-x-pos r) (rec-vel-x r)) (+ (rec-y-pos r) (rec-vel-y r)) (rec-vel-x r) (rec-vel-y r) false))

(begin-for-test
  (check-equal?
   (tick-rec rec-10-and-6)  (make-rec REC-IMAGE 12 8 10 6 false)))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
